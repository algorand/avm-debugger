...
export async function assertVariables(dc: DebugClient, {
	pc,
	stack,
	scratch,
	apps,
...
export async function advanceTo(dc: DebugClient, args: { program: string, line: number, column?: number} ) {
...
export async function assertEvaluationEquals(dc: DebugClient, frameId: number, expression: string, expected: { value: string, type?: string }) {
