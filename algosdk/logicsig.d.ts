 ...
 */
export declare function tealSign(sk: Uint8Array, data: Uint8Array, programHash: string): Uint8Array;
/**
 ...
 */
export declare function verifyTealSign(data: Uint8Array, programHash: string, sig: Uint8Array, pk: Uint8Array): boolean;
/**
