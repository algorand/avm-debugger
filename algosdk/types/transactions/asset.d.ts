...
declare type SpecificParametersForFreeze = Pick<TransactionParams, 'assetIndex' | 'freezeAccount' | 'assetFrozen'>;
...
declare type SpecificParametersForTransfer = Pick<TransactionParams, 'sender' | 'receiver' | 'closeRemainderTo' | 'assetSender' | 'amount' | 'assetIndex'>;
